...
public final class XMLLocation implements Location, Comparable<XMLLocation> {
    ...
    public static XMLLocation toXMLLocation(final String fileName, final Location location) {
    ...
    /**
     * Get the corresponding MSC location as a child of a parent location.
     *
     * @param parent the parent location (must not be {@code null})
     * @param nestingType the type of nesting within the parent (must not be {@code null})
     * @return the corresponding MSC location
     */
    public org.jboss.msc.problem.Location toMSCLocation(org.jboss.msc.problem.Location parent, org.jboss.msc.problem.Location.Nesting nestingType) {
        return new org.jboss.msc.problem.Location(fileName, lineNumber, columnNumber, parent, nestingType);
    }

    /**
     * Get the corresponding MSC location as a root location.
     *
     * @return the corresponding MSC location
     */
    public org.jboss.msc.problem.Location toMSCLocation() {
        return new org.jboss.msc.problem.Location(fileName, lineNumber, columnNumber);
    }
