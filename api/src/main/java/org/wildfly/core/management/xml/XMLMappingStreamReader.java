...
import org.wildfly.core.management.AbstractResourceBuilder;
...
public interface XMLMappingStreamReader extends XMLStreamReader {
     ...
     */
    <R extends ResourceNode> AbstractResourceBuilder<? extends R> parseAny(Class<R> baseType) throws XMLParseException;
