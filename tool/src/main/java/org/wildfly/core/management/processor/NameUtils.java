...
public final class NameUtils {
    ...
    private static final HashSet<String> IE_WORDS;

    static {
        final HashSet<String> set = new HashSet<>();
        try (InputStream stream = NameUtils.class.getResourceAsStream("ie-words.txt")) {
    ...
    /**
     * Finds the singular form of one single word.  CamelHumps and xml-style words will not produce a correct result;
     * these should be split first.
     *
     * @param plural the plural form
     * @return the singular form
     */
    public static String singularWord(String plural) {
        if (plural.endsWith("ies") && ! IE_WORDS.contains(plural)) {
